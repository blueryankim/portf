...
import circle.member.service.IdConfirmAndLoginService;
...
public class IdConfirmAndLoginController {
	...
	public ModelAndView idConfirm(IdConfirmAndLoginVO icvo) throws Exception{
		...
		if(idExistConfirm==0){
			...
			mav.setViewName("/member/idconfirmandlogin.jsp");
		...
		if(inputConfirm==0){
			...
			mav.setViewName("/member/idconfirmandlogin.jsp"); //setViewName설정
