	...
	function makeCommentView(comment) {
		...
		var html
			= '<table width="100%" border="0" cellpadding="0" cellspacing="0">'
				+ '<tr>'
					+ '<td width="140" align="left" valign="top"><b>' + comment.name + '</b></td>'
					+ '<td width="*">' + comment.content.replace(/\n/g, '\n<br/>') + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font color="#AAAAAA">' + comment.regdate + '</font></td>'
					+ '<td width="225"><input type="button" value="수정" onclick="viewUpdateForm(' + comment.id + ')"/>&nbsp;'
						+ '<input type="button" value="삭제" onclick="confirmDelection(' + comment.id + ')"/></td>'
				+ '</tr>'
				+ '<tr><td height="10" colspan="3"></td></tr>'
				+ '<tr><td height="1" colspan="3" bgcolor="${spline_1px}"></td></tr>'
				+ '<tr><td height="10" colspan="3"></td></tr>'
			+ '</table>';
											...
											<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
												...
												<tr>
													...
													<td colspan="2" align="right">
														<c:if test="${not empty sessionScope and sessionScope.id != null and sessionScope.id == vo.writer }">
															<input type="button" value="글수정" onclick="window.location='fupdateForm.do?num=${ vo.num }'" />
															<input type="button" value="글삭제" onclick="window.location='fdeleteForm.do?num=${ vo.num }'" />
														</c:if>
													</td>
													<td></td>
												</tr>
										...
										<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
											<tr>
												...
												<td colspan="2">
													...
													<!-- 입력된 댓글 보이는 영역 start -->
													<div id="commentList" class="body"></div>
													<!-- 입력된 댓글 보이는 영역 end -->
																...
																<tr>
																	<td>
																		<table border="0" cellpadding="0" cellspacing="0">
																			<tr>
																				<td valign="top">이름 : <input type="text" name="name" value="${ sessionScope.id }" readonly="readonly" style="width:100px;" /></td>
																				<td width="10"><input type="hidden" name="num" value="${vo.num }" /></td>
																				<td valign="top"><textarea name="content" style="width:500px;height:50px;"></textarea></td>
																				<td width="10"></td>
																				<td><input type="button" value="댓글등록" onclick="addComment()" style="width:70px;height:50px;text-align:center;" /></td>
																			</tr>
																		</table>
																	</td>
																</tr>
															...
															<table width="100%" border="0" cellpadding="0" cellspacing="0">
																<tr>
																	<td>
																		...
																		<table border="0" cellpadding="0" cellspacing="0">
																			<tr>
																				<td valign="top">이름 : <input type="text" name="name" style="width:100px;" /></td>
																				<td width="10"><input type="hidden" name="num" value="${vo.num }" /></td>
																				<td valign="top"><textarea name="content" style="width:500px;height:50px;"></textarea></td>
																				<td width="10"></td>
																				<td>
																					<input type="button" value="댓글수정" onclick="updateComment()" style="width:70px;height:50px;text-align:center;" />
																					<input type="button" value="취소" onclick="cancleUpdate()" style="width:50px;height:50px;text-align:center;" />
																				</td>
																			</tr>
																		</table>
																	</td>
	...
	<form method="post" name="writeForm">
		...
		<center>
			...
			<br />  <input
				...
				onclick="window.location='fupdateForm.do?num=${vo.num }'" /> <input
				type="button" value="글삭제"
				onclick="window.location='fdeleteForm.do?num=${vo.num }'" /> <input
				type="button" value="목록보기" onclick="window.location='flist.do'" />
		</center>
	</form>
</div>
