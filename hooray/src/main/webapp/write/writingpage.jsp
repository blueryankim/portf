...
<script type="text/javascript">
    ...
    function writingValidation(){
		...
		$.ajax({
    		...
    		type:"POST",
    		url:"/hooray/write/uploadproject.do",
    		contentType:false,
    		cache:false,
    		processData:false,
    		enctype:'multipart/form-data',
...
<option value="1">자원봉사</option>
<option value="2">재능기부</option>
<option value="3">공연,행사</option>
<option value="4">상품판매</option> 
</select>


<input name="maintitle" id="maintitle" type="text" size="0" placeholder="주제목"/>

<input name="subtitle" id="subtitle" type="text" size="0"	 placeholder="부제목"/>

<input type="text" name="limitpeople" id="limitpeople" size="0" placeholder="참여인원">

<input type="text" name="period" id="period" size="0" placeholder="모집 기한">
...
<input type="text" name="city" id="city" placeholder="(시,군,구)">
<div id="filebox">
...
<input type="text" name="lastimgnum" id="lastimgnum" value="1" style="display:none;">
...
<input type="button" value="메인화면으로" onclick="window.location='homepage.do'"/>
</div>
</div>
