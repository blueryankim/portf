...
<html lang="ko">
<head>
<link href='http://fonts.googleapis.com/css?family=Pacifico' rel='stylesheet' type='text/css'><style>
...
<div id="left-panel" data-role="panel" data-theme="a" data-display="reveal" data-position-fixed="true" data-position="left" data-inset="false">
          ...
          <ul id="panellistview" data-role="listview" data-theme="a" data-insert="true">
          	<li id="top" data-role="list-divider" data-theme="c"><h3 id="loginid">${loginerinfor.id}</h3></li>
...
<div class="visual" data-inset="false"><img src="./image/IMG_1652.JPG"/></div>
</div>

<div id="content" data-role="content" data-inset="false" data-theme="a">
<div class="ui-grid-a" id="uigrida">

	<c:if test="${  not empty writinggridlist }">
	<c:forEach var="wgl" items="${ writinggridlist }" varStatus="status">
	<c:if test="${ status.index %2 ==0}">
	<div class="ui-block-a" ><a href="#"><img src="../thumbnails/${wgl.num}.jpg"/></a><div class="imgCaption">${wgl.title}
	<br/><span>${wgl.subtitle}</span>
	</div></div>
	</c:if>
	<c:if test="${ status.index %2 ==1}">
	<div class="ui-block-b"><a href="#"><img src="../thumbnails/${wgl.num}.jpg"/></a><div class="imgCaption">${wgl.title}
	<br/><span>${wgl.subtitle}</span>
	</div></div>
	</c:if>
	<c:if test="${ empty bgl}">
	...
	<c:if test="${  empty writinggridlist }">
...
<ul>
	...
	<li><a href="/Finder/gridpage/bringgridpage.do?flag=writinggird" data-ajax="false" class="ui-btn-active"  data-id="writinginfo">글나누기</a></li>
</ul>
</div>
